...
class Genre(models.Model):
    ...
    """
    name = models.CharField(max_length=128, help_text="Enter a book genre (e.g. Science Fiction, French Poetry etc.)")
...
class Book(models.Model):
    """
    Model representing a book ( but not a specific instance )
    """
